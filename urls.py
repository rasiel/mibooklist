...
urlpatterns = patterns('',
    ...
    url(r'^contact-seller/$',contact_form, {'form_class': ContactSellerForm,'success_url': '/contact-seller/sent/', 'template_name': 'contact_form/seller_form.html'}, name='contact_seller',),
