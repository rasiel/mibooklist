...
from sellers.forms import SellerForm


def create_profile(request, form_class=SellerForm, success_url=None,
...
def edit_profile(request, form_class=SellerForm, success_url=None,
